      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              Hello, I&apos;m
              <br />
              {/* ✅ Fix 3: Name is "Alok Jha" — kept consistent */}
            ...
            >
              "I architect end-to-end digital products — from robust Node.js APIs and MongoDB schemas to pixel-perfect React interfaces that users love."
            </motion.p>
            ...
            >
              {/* ✅ Fix 4: href="#projects" — make sure Projects section has id="projects" */}
              <a
                href="#projects"
        ...
        >
          ...
          <motion.img
            ...
            style={{ right: "-30px", width: "min(95vw, 780px)", maxHeight: "100vh" }}
...
// ✅ Fix 5: Added displayName for better debugging with React DevTools
